...
const seoFaq: Array<{ q: string; a: string }> = [
  ...
  { q: "What happens to my data if I stay on Free forever?", a: "It stays yours, exportable as JSON on request, with memory text and settings included and embeddings excluded. If you confirm Delete account in Settings, irreversible erasure begins immediately; you can download an optional export first. Some provider records follow separate retention rules described in the privacy guide. Self-hosters hold the same MIT code and data on their own machines. Free means free, with no trial clock quietly converting you into a paying customer." },
];
