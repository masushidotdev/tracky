...
Observed on a provider sandbox account during development. This model assumes a money box
...
**net of** the pockets — the app showed a small main balance while three pockets held the bulk of the funds, and the provider delivered only the net balance — and it does not
