...
### Doppio conteggio del saldo carta (trovato durante i test con dati sintetici, 2026-07-21)

Il drill-down ha mostrato che la riga «Rate e finanziamenti» conteneva un pagamento di estratto conto carta di importo quasi pari al debito residuo. Quel movimento **non deve** ridurre la liquidità del piano:
